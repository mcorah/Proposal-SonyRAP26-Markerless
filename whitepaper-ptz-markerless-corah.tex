...
\paragraph{Research Plan \& Technical Approach}
...
densities over subjects' surfaces for multiple cameras jointly~\citep{7,8}.
...
previously for systems consisting of multiple PTZ cameras~\citep{6} or
UAVs~\citep{2,3,4,5}.
...
\setlength{\figureheight}{1.2in}
      ...
      \caption{%
        Illustration of a view planning scenario taken from~\citep{8}.
