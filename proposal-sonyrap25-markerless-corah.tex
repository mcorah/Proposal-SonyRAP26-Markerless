...
\subsection{Gap: aerial motion capture}
...
Specifically, these prior works do not address challenges related to
...
Aside from technical limitations and although the challenge of aerial motion
capture is compelling,
aerial platforms do not necessarily provide a desirable format for motion
capture.
Limits on battery life produce either limits on operation time or else intense
logistical challenges related to refreshing batteries.
Operators must also ensure the safety of subjects being filmed by some
...
\subsection{Gap: Motion capture with pan-tilt-zoom units}
...
fixed cameras to likewise observe and reconstruct motions of subjects as they
...
capture capabilities based on PTZ cameras.
