...
\begin{figure}
  \centering
  \includegraphics[width=0.4\linewidth,angle=-90]{figures/markerless_sketch}
  \caption{Graphical illustration of the proposed approach to
    markerless motion capture with multiple tracked subjects based on an
    ...
    reconstruction developing methods such as Gaussian splatting.
  }%
...
\begin{figure}
  \rule{\textwidth}{2in}
  \caption{Motion capture system and truss to be leverage for laboratory
    experiments. Pan-tilt-zoom videography system showing three
    of four cameras owned by NAPPLab.
    Illustrations of current tracking and videography capabilities being
